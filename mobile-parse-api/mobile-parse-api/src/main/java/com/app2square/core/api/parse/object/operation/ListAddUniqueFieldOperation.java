 ...
 * @author cs
 */
class ListAddUniqueFieldOperation extends AbstractListOperation {

    ListAddUniqueFieldOperation(final Json json, final HttpMethodFactory factory, final ParseObject object,
