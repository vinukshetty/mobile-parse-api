 ...
 * @author cs
 */
class RemoveRelationFieldOperation extends AbstractRelationOperation {

    RemoveRelationFieldOperation(final Json json, final HttpMethodFactory factory, final ParseObject object,
