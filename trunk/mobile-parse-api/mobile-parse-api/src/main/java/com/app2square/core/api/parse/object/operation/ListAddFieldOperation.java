 ...
 * @author cs
 */
class ListAddFieldOperation extends AbstractListOperation {

    ListAddFieldOperation(final Json json, final HttpMethodFactory factory, final ParseObject object,
