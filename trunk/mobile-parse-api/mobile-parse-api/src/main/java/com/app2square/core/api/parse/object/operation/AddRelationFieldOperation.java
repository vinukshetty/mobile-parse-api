 ...
 * @author cs
 */
class AddRelationFieldOperation extends AbstractRelationOperation {

    public AddRelationFieldOperation(final Json json, final HttpMethodFactory factory, final ParseObject object,
